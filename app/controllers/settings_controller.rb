class SettingsController < ApplicationController
  ...
  before_action :only1setting, only: %i[ new ]

  def only1setting
    unless Setting.last == nil
      flash[:alert] = 'You already have settings!'
      redirect_to '/journalistdashboard'
    end
  end
  ...
  private
    ...
    def setting_params
      params.require(:setting).permit(:newspapername, :tagline, :theme_id)
    end
end
